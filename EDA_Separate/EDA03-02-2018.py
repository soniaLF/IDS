...
# output_path = '../archive/03-02-2018_cleaned.csv'
...
# path5='../archive/03-02-2018_cleaned.csv'
# ds5 = pd.read_csv(path5)
...
# plt.title("Percentuale di flussi benigni e maligni nel dataset 03-02-2018")
# plt.show()
#
