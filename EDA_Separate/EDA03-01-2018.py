...
ds4.to_csv('../archive/03-01-2018TuttiFloat.csv')

#3-Le feature che devono essere degli int le trasformo usando la funzione asType()

path5='../archive/03-01-2018TuttiFloat.csv'
...
output_path = '../archive/03-01-2018_cleaned.csv'
...
#
# path='../archive/03-01-2018_cleaned.csv'
#
# ds = pd.read_csv(path)
#
...
# plt.title("Percentuale di flussi benigni e maligni nel dataset 03-01-2018")
# plt.show()
#
#
#
