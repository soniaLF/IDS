#IDS Data preprocessing con Dataset: CICIDS2018-GeneratedLabelflow
...
ds4.to_csv('../archive/02-28-2018TuttiFloat.csv')

#3-Le feature che devono essere degli int le trasformo usando la funzione asType()

path5='../archive/02-28-2018TuttiFloat.csv'
...
output_path = '../archive/02-28-2018_cleaned.csv'
...
# path5='../archive/02-28-2018_cleaned.csv'
# ds5 = pd.read_csv(path5)
#
...
# plt.title("Percentuale di flussi benigni e maligni nel dataset 02-28-2018")
# plt.show()
#
#
#
